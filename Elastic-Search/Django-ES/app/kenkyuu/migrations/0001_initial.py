# Generated by Django 3.2.7 on 2021-10-03 19:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(related_name='books', to='kenkyuu.Author')),
                ('publisher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='kenkyuu.publisher')),
                ('tags', models.ManyToManyField(blank=True, related_name='books', to='kenkyuu.Tag')),
            ],
            options={
                'ordering': ['isbn'],
            },
